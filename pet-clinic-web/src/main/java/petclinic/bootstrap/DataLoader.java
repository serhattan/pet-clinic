...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        Speciality savedDestistry = specialityService.save(dentistry);

        Owner owner1 = new Owner();
        owner1.setFirstName("Micheal");
        owner1.setLastName("Jordan");
        owner1.setAddress("Maslak Caddesi");
        owner1.setCity("İstanbul");
        owner1.setTelephone("05462123123");

        Pet mikesPet = new Pet();
        mikesPet.setPetType(savedDogPetType);
        mikesPet.setOwner(owner1);
        mikesPet.setBirthDate(LocalDate.now());
        mikesPet.setName("Boncuk");
        ...
        owner2.setAddress("1413 sokak");
        owner2.setCity("Izmir");
        owner2.setTelephone("05324323123");
